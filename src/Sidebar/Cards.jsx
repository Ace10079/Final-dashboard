...
function Cards() {
  return (
    <div className='flex flex-col justify-center lg:flex-row lg:m-2 lg:gap-10 font-bold text-sm'>
      <div className='border-solid border-2 items-center lg:justify-between justify-between rounded-lg flex lg:gap-3 ml-14 mt-3 bg-slate-100 hover:shadow-2xl w-64 lg:w-72 lg:m-2'>
        <div className='p-3'>
      ...
      <div className='border-solid border-2 items-center rounded-lg lg:justify-between justify-between flex lg:gap-3 ml-14 mt-3 bg-slate-100 hover:shadow-2xl w-64 lg:w-72 lg:m-2'>
        <div className='p-3'>
