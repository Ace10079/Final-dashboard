...
import { IconMenuDeep, IconDashboard, IconUser, IconSearch, IconUsers } from '@tabler/icons-react';
...
function Sidebar() {
    ...
    return (
        <div className="lg:relative relative">
            <div className={`${open ? "lg:w-[220px] w-[420px] h-[280px] lg:static absolute" : "lg:w-[50px] w-[0px] "} duration-300 lg:bg-green-700 bg-green-700 lg:h-screen sidebar-text`} >
